...
ALLOWED_HOSTS = ['47.129.180.22', '.ngrok-free.app']
...
# Redis instead of inmemory database?
CHANNEL_LAYERS = {
    'default': {
...
'''
# Amazon RDS PostgreSQL database - using environment variables
...
# DEBUG = False
# ALLOWED_HOSTS = ['your-domain.com', 'your-aws-load-balancer.amazonaws.com']

# Update CORS for production (uncomment and update when you have frontend URL)
